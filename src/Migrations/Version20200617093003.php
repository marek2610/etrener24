 ...
 */
final class Version20200617093003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zawodnik CHANGE grupa_krwi_id grupa_krwi_id INT DEFAULT NULL, CHANGE pesel pesel VARCHAR(11) DEFAULT NULL, CHANGE miejsce_urodzenia miejsce_urodzenia VARCHAR(255) DEFAULT NULL, CHANGE adres adres VARCHAR(255) DEFAULT NULL, CHANGE kod_pocztowy kod_pocztowy VARCHAR(255) DEFAULT NULL, CHANGE miejscowosc miejscowosc VARCHAR(255) DEFAULT NULL, CHANGE poczta poczta VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE telefon telefon VARCHAR(255) DEFAULT NULL, CHANGE noga noga VARCHAR(255) DEFAULT NULL, CHANGE szkola szkola VARCHAR(255) DEFAULT NULL, CHANGE wzrost wzrost INT DEFAULT NULL, CHANGE waga waga INT DEFAULT NULL, CHANGE pozycja pozycja VARCHAR(255) DEFAULT NULL, CHANGE pierwszy_klub pierwszy_klub VARCHAR(255) DEFAULT NULL, CHANGE numer_na_koszulce numer_na_koszulce VARCHAR(255) DEFAULT NULL, CHANGE nr_karty_zawodnika nr_karty_zawodnika VARCHAR(255) DEFAULT NULL, CHANGE data_waznosci_karty data_waznosci_karty DATETIME DEFAULT NULL, CHANGE data_rejestracji_wklubie data_rejestracji_wklubie DATETIME DEFAULT NULL, CHANGE imie_rodzica imie_rodzica VARCHAR(255) DEFAULT NULL, CHANGE naziwsko_rodzica naziwsko_rodzica VARCHAR(255) DEFAULT NULL, CHANGE email_rodzica email_rodzica VARCHAR(255) DEFAULT NULL, CHANGE nr_telefonu_rodzica nr_telefonu_rodzica VARCHAR(255) DEFAULT NULL, CHANGE data_utworzenia data_utworzenia DATETIME DEFAULT NULL, CHANGE data_modyfikacji data_modyfikacji DATETIME DEFAULT NULL, CHANGE druzyna druzyna VARCHAR(11) DEFAULT NULL, CHANGE status status VARCHAR(15) DEFAULT NULL');
        $this->addSql('ALTER TABLE urazy CHANGE zawodnik_id zawodnik_id INT DEFAULT NULL');
    }
